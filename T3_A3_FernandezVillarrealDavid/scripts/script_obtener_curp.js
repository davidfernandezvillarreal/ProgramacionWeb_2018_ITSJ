function obtenerCURP() {
    var nombre = document.getElementById("cajaNombre").value.toUpperCase();
    var primerAp = document.getElementById("cajaPrimerAp").value.toUpperCase();
    var segundoAp = document.getElementById("cajaSegundoAp").value.toUpperCase();
    var fechaNac = document.getElementById("cajaFechaNac").value;
    var entidadNac = document.getElementById("cajaEntidadNacimiento").value.toUpperCase();
    var sexo = document.getElementById("cajaSexo").value.toUpperCase();
